...
- Models: add `models auth remove --provider <id>` CLI command and configure wizard option to fully remove a provider's configuration, model refs, and auth credentials. (#10244)
